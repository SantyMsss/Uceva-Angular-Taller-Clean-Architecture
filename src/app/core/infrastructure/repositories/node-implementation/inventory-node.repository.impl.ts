...
/**
 * Implementación concreta del repositorio de inventarios para Node.js.
 *
 * @remarks
 ...
 */
@Injectable()
export class InventoryNodeRepositoryImpl extends InventoryRepository {
    ...
    getAll(countInventories: number): Observable<Inventory[]> {
        return this.dataService.getAllInventoryNode(countInventories);
    }
