...
/**
 * Implementación concreta del repositorio de inventarios para SpringBoot.
 *
 * @remarks
 ...
 */
@Injectable()
export class InventorySpringBootRepositoryImpl extends InventoryRepository {
    ...
    getAll(countInventories: number): Observable<Inventory[]> {
        return this.dataService.getAllInventorySpringBoot(countInventories);
    }
